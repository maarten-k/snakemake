...
## [8.0.0](https://github.com/maarten-k/snakemake/compare/v7.28.3...v8.0.0) (2023-06-16)


### ⚠ BREAKING CHANGES

* template rendering integration (yte and jinja2), require Python 3.6 as minimum version (f-string support) ([#1410](https://github.com/maarten-k/snakemake/issues/1410))

### Features

* ability to encode paramspaces into a single wildcard, via the newly introduced `single_wildcard` argument of `Paramspace`. ([#2069](https://github.com/maarten-k/snakemake/issues/2069)) ([728ab3c](https://github.com/maarten-k/snakemake/commit/728ab3cf59fb188bf1872a5cab3aba4519340a06))
* add  keyword to gridftp remote provide to specify the number or disable usage of multiple data stream ([#1974](https://github.com/maarten-k/snakemake/issues/1974)) ([3e6675d](https://github.com/maarten-k/snakemake/commit/3e6675df26bf65fa27006ea57a4c3cf36b89d6da))
* add Bash script functionality ([#1821](https://github.com/maarten-k/snakemake/issues/1821)) ([c4cf8fd](https://github.com/maarten-k/snakemake/commit/c4cf8fdb119e678e51fd1932392699957c63b6c4))
* add cleanup containers option ([#2088](https://github.com/maarten-k/snakemake/issues/2088)) ([053e3b3](https://github.com/maarten-k/snakemake/commit/053e3b37cfcc6c67bae6ac3660b82879b75acb4c))
* add flag `ensure` that allows to annotate that certain output files should be non-empty or agree with a given checksum ([#1651](https://github.com/maarten-k/snakemake/issues/1651)) ([76f69d9](https://github.com/maarten-k/snakemake/commit/76f69d9e21b9c9a9a01198862b66284bc3942d20))
* add gitfile option to make it possible to use local git repos when importing modules ([#1376](https://github.com/maarten-k/snakemake/issues/1376)) ([1a3b91f](https://github.com/maarten-k/snakemake/commit/1a3b91fa8461d44bc1583f1d2e33ff2bae1360b3))
* add pyproject.toml to use setuptools features ([#1725](https://github.com/maarten-k/snakemake/issues/1725)) ([454bfd1](https://github.com/maarten-k/snakemake/commit/454bfd17aba8631ea34d6a8971b1db60b2955965))
* Add support for tokens in the XRootD interface ([#2076](https://github.com/maarten-k/snakemake/issues/2076)) ([bca013a](https://github.com/maarten-k/snakemake/commit/bca013acdb4508e388b621cd970f65082f88150f))
* add tes token ([#1966](https://github.com/maarten-k/snakemake/issues/1966)) ([59a8fa0](https://github.com/maarten-k/snakemake/commit/59a8fa04c4c6b113775fe11228b82510ecd36cb8))
* Add token auth to GitLab/GitHub hosting providers ([#1761](https://github.com/maarten-k/snakemake/issues/1761)) ([e03a3b4](https://github.com/maarten-k/snakemake/commit/e03a3b42eea89d512290bf98ee7d77ce2e17447c)), closes [#1301](https://github.com/maarten-k/snakemake/issues/1301)
* added localrule directive ([#2180](https://github.com/maarten-k/snakemake/issues/2180)) ([9c990b0](https://github.com/maarten-k/snakemake/commit/9c990b076b51e9e2123ced56bfab176e03424770))
* Added timestamp to each log message ([#1304](https://github.com/maarten-k/snakemake/issues/1304)) ([a5769f0](https://github.com/maarten-k/snakemake/commit/a5769f0baeaa829b7813dee8c78902edbb42cf4b))
* Adding --cluster-cancel and --cluster-cancel-nargs ([#1395](https://github.com/maarten-k/snakemake/issues/1395)) ([0593de1](https://github.com/maarten-k/snakemake/commit/0593de134499712929ba75e65f65df90491eac2e))
* adding default_target directive for declaring default target rules that are not the first rule in the workflow. ([#1358](https://github.com/maarten-k/snakemake/issues/1358)) ([638ec1a](https://github.com/maarten-k/snakemake/commit/638ec1a983741cd7ba8faaf1a9dc76ae43d012e5))
* adding flux executor ([#1810](https://github.com/maarten-k/snakemake/issues/1810)) ([40d2bd0](https://github.com/maarten-k/snakemake/commit/40d2bd071984914ac511e7858690dfd16cefaf69))
* adding service jobs, i.e. the ability to define jobs that provide a resource for consumers (like a shared memory device or a database), and will be automatically terminated by Snakemake once all consumers are finished. ([#1413](https://github.com/maarten-k/snakemake/issues/1413)) ([a471adb](https://github.com/maarten-k/snakemake/commit/a471adbb785e5ac7f0c854fd09781c502b577c65))
* allow config files to be processed with YTE ([#2269](https://github.com/maarten-k/snakemake/issues/2269)) ([8e1c22f](https://github.com/maarten-k/snakemake/commit/8e1c22ff54e85ee941c6e0ac74dd594fce80efbb))
* allow for human friendly resource definitions (e.g. mem="5GB", runtime="1d") ([#1861](https://github.com/maarten-k/snakemake/issues/1861)) ([24610ac](https://github.com/maarten-k/snakemake/commit/24610ac75849d543fc38c83fb2454fa4f9b42075))
* allow input, output, and params to be used in functions passed to report mark arguments ([#2081](https://github.com/maarten-k/snakemake/issues/2081)) ([93ff8b6](https://github.com/maarten-k/snakemake/commit/93ff8b604a152f50ca31389ecffe1a7527c5b5a8))
* Allow paramspace to separate filename params with custom separator ([#1299](https://github.com/maarten-k/snakemake/issues/1299)) ([8236e80](https://github.com/maarten-k/snakemake/commit/8236e80794d0f9c9670238ba168770c0947e8379))
* allow prefix definition in module statements ([#1310](https://github.com/maarten-k/snakemake/issues/1310)) ([29e6540](https://github.com/maarten-k/snakemake/commit/29e6540aac95b08b5e386a8478bd2013334e5954))
* Allow the environment variable SNAKEMAKE_CONDA_PREFIX to be present without --use-conda ([#2263](https://github.com/maarten-k/snakemake/issues/2263)) ([e4eba8d](https://github.com/maarten-k/snakemake/commit/e4eba8d72b84aaa460c7d1b1ac54b607e844d782))
* allow to define the cache mode per rule (this enables to exclude software envs from the caching hash value, which can be handy e.g. for download rules where the software version does not affect the result) ([#1933](https://github.com/maarten-k/snakemake/issues/1933)) ([715e618](https://github.com/maarten-k/snakemake/commit/715e6187e9a132c2a61f5bef34a1e10491680b0a))
* automatically rerun jobs if parameters, code, input file set, or software stack changed (thanks to [@cclienty](https://github.com/cclienty) and [@timtroendle](https://github.com/timtroendle)). This also increases performance of DAG building by handling job "needrun" updates level wise, while avoiding to perform a full check for those jobs that are already downstream of a job that has been determined to require a rerun. ([#1663](https://github.com/maarten-k/snakemake/issues/1663)) ([4c11893](https://github.com/maarten-k/snakemake/commit/4c11893d2fda5824adff44d16d7741484e63efea))
* Azbatch executor ([#1953](https://github.com/maarten-k/snakemake/issues/1953)) ([#2246](https://github.com/maarten-k/snakemake/issues/2246)) ([0f9c49f](https://github.com/maarten-k/snakemake/commit/0f9c49fe8643cca0e42e3b091cf9706a7feb877d))
* changed report layout to display menu always left of the results. For fullscreen, one can still hide the menu, which leads to automatic growth of the results ([#2116](https://github.com/maarten-k/snakemake/issues/2116)) ([d771b1b](https://github.com/maarten-k/snakemake/commit/d771b1b5fc8344aaffe1f30388d4e4d31d4fe937))
* cluster sidecar ([#1397](https://github.com/maarten-k/snakemake/issues/1397)) ([b992cd1](https://github.com/maarten-k/snakemake/commit/b992cd19dc1c011f536e3662a3ddffc8b1bb9f67))
* enable restricted access support in zenodo remote provider ([#1623](https://github.com/maarten-k/snakemake/issues/1623)) ([692caf9](https://github.com/maarten-k/snakemake/commit/692caf963d90313d2cd8117fecde097b228633ce))
* enable the definition of conda pin files in order to freeze an environment. This can drastically increase the robustness because it allows to freeze an environment at a working state. ([#1667](https://github.com/maarten-k/snakemake/issues/1667)) ([53972bf](https://github.com/maarten-k/snakemake/commit/53972bfddcca836d5abb8cdd452cbea40ab2571f))
* first try to match output files against input files while persisting wildcard values from the consuming job. This can dramatically reduce ambiuity problems. Thanks to [@descostesn](https://github.com/descostesn)! ([#1939](https://github.com/maarten-k/snakemake/issues/1939)) ([d093907](https://github.com/maarten-k/snakemake/commit/d093907417778c7693a05ed1f38fc40b8d34d9ba))
* for small files, compare checksums to determine if job needs to run if input file is newer than output file ([#1568](https://github.com/maarten-k/snakemake/issues/1568)) ([1ae85c6](https://github.com/maarten-k/snakemake/commit/1ae85c6b57b3c6b5860214a9c0e3ab28c7c8c5dc))
* Group resources ([#1218](https://github.com/maarten-k/snakemake/issues/1218)) ([a8014d0](https://github.com/maarten-k/snakemake/commit/a8014d030a2a3ea04743e30bcf5164801291378f))
* implement support for removing GFAL remote files ([#1103](https://github.com/maarten-k/snakemake/issues/1103)) ([25943e5](https://github.com/maarten-k/snakemake/commit/25943e5630ff6d83afa5cba28edf473ce2ca87da))
* improved reports: more interactive and modern interface, ability to define a label based representation of files ([#1470](https://github.com/maarten-k/snakemake/issues/1470)) ([d09df0c](https://github.com/maarten-k/snakemake/commit/d09df0c6b02494829345f0af0fa8811007afa28b))
* k8s: add --k8s-cpu-scalar ([#1857](https://github.com/maarten-k/snakemake/issues/1857)) ([a067a1b](https://github.com/maarten-k/snakemake/commit/a067a1b6eb8f6432348bc257782faba40f89e805))
* limit the number of input/output files in job properties ([#2149](https://github.com/maarten-k/snakemake/issues/2149)) ([d93f091](https://github.com/maarten-k/snakemake/commit/d93f091acea63a662dcb350c3f86c15fa9bdf721))
* LockException ([#1276](https://github.com/maarten-k/snakemake/issues/1276)) ([f5e6fa6](https://github.com/maarten-k/snakemake/commit/f5e6fa68a68640ed39df86c256d676f2e4efddfc))
* make it possible to exclude rules that will be imported when using 'use rule' statement ([#1717](https://github.com/maarten-k/snakemake/issues/1717)) ([d9e0611](https://github.com/maarten-k/snakemake/commit/d9e061178bd22307cc710bea28a5994e866260d9))
* new directive "retries" for annotating the number of times a job shall be restarted after a failure ([#1649](https://github.com/maarten-k/snakemake/issues/1649)) ([c8d81d0](https://github.com/maarten-k/snakemake/commit/c8d81d03de2885d5d0473084141e9f6abc5de445))
* print reason summary in case of dryrun ([#1778](https://github.com/maarten-k/snakemake/issues/1778)) ([bd2a68b](https://github.com/maarten-k/snakemake/commit/bd2a68bb8a7ddb64ad91bb822aa7d0342e884704))
* provide information about temp, pipe, and service files in --summary ([#1977](https://github.com/maarten-k/snakemake/issues/1977)) ([c7c7776](https://github.com/maarten-k/snakemake/commit/c7c7776f8722adf94e6a176174cb0a7564f11d9f))
* Publish docker images for amd64 & arm64 ([#2105](https://github.com/maarten-k/snakemake/issues/2105)) ([4c898f5](https://github.com/maarten-k/snakemake/commit/4c898f5587d832c45f0b534681f9502abe1de6ce))
* require at least Python 3.7 ([fd5daae](https://github.com/maarten-k/snakemake/commit/fd5daaeff070f9987dba411a0f5262c533a2f666))
* SLURM executor ([#1015](https://github.com/maarten-k/snakemake/issues/1015)) ([c7ea059](https://github.com/maarten-k/snakemake/commit/c7ea0590c396c67fa5d56042e21f678c20784d3b))
* specify conda environments via their name ([#1340](https://github.com/maarten-k/snakemake/issues/1340)) ([735ab23](https://github.com/maarten-k/snakemake/commit/735ab2301d0905ea054ad6efa3150acb296d0e78))
* Support conda environment definitions to be passed as function pointers, similar to input, params, and resources ([#1300](https://github.com/maarten-k/snakemake/issues/1300)) ([6f582f1](https://github.com/maarten-k/snakemake/commit/6f582f180f5df9292e005623f093a3a0b2e597a7))
* support for group local jobs by enabling optional groupid consideration in input functions ([#1418](https://github.com/maarten-k/snakemake/issues/1418)) ([5d45493](https://github.com/maarten-k/snakemake/commit/5d45493db4485af2f4b288b5002605c87315d2b7))
* Support for machine_type for kubernetes executor ([#1291](https://github.com/maarten-k/snakemake/issues/1291)) ([12d6f67](https://github.com/maarten-k/snakemake/commit/12d6f67a19a55ead092c80b2e5b49e1836fb4e5f))
* support for post deploy scripts ([#1325](https://github.com/maarten-k/snakemake/issues/1325)) ([e5dac4f](https://github.com/maarten-k/snakemake/commit/e5dac4ff297b7aeeb1e1a0bbdd03cb967cee3011))
* template rendering integration (yte and jinja2), require Python 3.6 as minimum version (f-string support) ([#1410](https://github.com/maarten-k/snakemake/issues/1410)) ([e1cbde5](https://github.com/maarten-k/snakemake/commit/e1cbde5a378a29e3e7c7c16c73e08b35afa47a56))
* Tes auth ([#2169](https://github.com/maarten-k/snakemake/issues/2169)) ([3326a6f](https://github.com/maarten-k/snakemake/commit/3326a6f7bbaf9c277400625649c3da903e251e2f))
* vim syntax updates ([#1584](https://github.com/maarten-k/snakemake/issues/1584)) ([b8c77f6](https://github.com/maarten-k/snakemake/commit/b8c77f6a2a1372a5c3ad8077ad36facf393bfacf))
* Zenodo remote provider for transparent storage on and retrieval from Zenodo ([#1455](https://github.com/maarten-k/snakemake/issues/1455)) ([4586ef7](https://github.com/maarten-k/snakemake/commit/4586ef7c9e5945568e9994a013235574c24d582f))


### Bug Fixes

* --conda-frontend value not passed on to cluster jobs ([#1317](https://github.com/maarten-k/snakemake/issues/1317)) ([df46ddb](https://github.com/maarten-k/snakemake/commit/df46ddb37022b291a4feca22fd0fbcf8773e7d03))
* :bug: - fix hyperlink ([#2046](https://github.com/maarten-k/snakemake/issues/2046)) ([9519d31](https://github.com/maarten-k/snakemake/commit/9519d31b4ed2390d5c14f0f6a754ca665374d15c))
* [#2130](https://github.com/maarten-k/snakemake/issues/2130) by patching the protect() method so the path of files in subdirectories is properly resolved during write-protection ([#2131](https://github.com/maarten-k/snakemake/issues/2131)) ([1a754fd](https://github.com/maarten-k/snakemake/commit/1a754fd094bd13bb4a201f1c80a077656c89f995))
* `sre_constants` import because of deprecation ([#2139](https://github.com/maarten-k/snakemake/issues/2139)) ([3b326db](https://github.com/maarten-k/snakemake/commit/3b326dba22ef5358092c281479eafafe3480eeae))
* 2142 log directive in default target rule ([#2191](https://github.com/maarten-k/snakemake/issues/2191)) ([86e9624](https://github.com/maarten-k/snakemake/commit/86e962488dcd346cd0a29a2ff1b2dcd1abafb841))
* adapt linting rule to Python 3.11 ([a3a5c58](https://github.com/maarten-k/snakemake/commit/a3a5c58cbbbe9a84b7383ce046b5981271288979))
* add about page to report, including embedded packages and licenses ([#1511](https://github.com/maarten-k/snakemake/issues/1511)) ([142a452](https://github.com/maarten-k/snakemake/commit/142a45256f1b192246dd8e9843abedb24badecc6))
* Add back logging of run directives ([#1883](https://github.com/maarten-k/snakemake/issues/1883)) ([a65559c](https://github.com/maarten-k/snakemake/commit/a65559c1e21d65e5b4509b9565b472e734ab9f02))
* add local marker for input files in cufflinks example. fixes issue [#1362](https://github.com/maarten-k/snakemake/issues/1362) ([90bc88b](https://github.com/maarten-k/snakemake/commit/90bc88b84282b477f481e368ad657056e131cbdc))
* add lock free mechanism for avoiding race conditions when writing persistence information; consider corrupt metadata records as non-existent ([#1745](https://github.com/maarten-k/snakemake/issues/1745)) ([71fe952](https://github.com/maarten-k/snakemake/commit/71fe9527bb7011ba01d25fdd21c102c135412c04))
* add missing report.templates.components module to setup.py ([cb4e3fe](https://github.com/maarten-k/snakemake/commit/cb4e3feaa192ed9c53ddb7c965cb5b71297710c9))
* addressing [#2197](https://github.com/maarten-k/snakemake/issues/2197) by allowing 256 character account names in slurm ([#2198](https://github.com/maarten-k/snakemake/issues/2198)) ([ab58c65](https://github.com/maarten-k/snakemake/commit/ab58c652847c03a9f1529d2d7632f2788a5fadc4))
* allocation of local ssds in k8s tests ([#1870](https://github.com/maarten-k/snakemake/issues/1870)) ([d0de4dc](https://github.com/maarten-k/snakemake/commit/d0de4dccf6f6c749da0d4a30ef27fe0f9274995d))
* allow apptainer as a successor to singularity. ([#1706](https://github.com/maarten-k/snakemake/issues/1706)) ([bcbdb0b](https://github.com/maarten-k/snakemake/commit/bcbdb0bc44746961838f9603e42d0e171407c740))
* allow labels function to return None ([#1565](https://github.com/maarten-k/snakemake/issues/1565)) ([fef74d6](https://github.com/maarten-k/snakemake/commit/fef74d6406a04e29c115a699e76ac96e4a37cf9e))
* allow report generation to handle pathlib objects ([#1904](https://github.com/maarten-k/snakemake/issues/1904)) ([7c34656](https://github.com/maarten-k/snakemake/commit/7c346569106a36bbbce990576324af472ada9efd))
* allow script directive to take pathlib Path ([#1869](https://github.com/maarten-k/snakemake/issues/1869)) ([12cdc96](https://github.com/maarten-k/snakemake/commit/12cdc961c86541d5c50533a6b8ff5df0cb6fd7d1))
* allow to use {wildcards} for group jobs in cluster config ([#1555](https://github.com/maarten-k/snakemake/issues/1555)) ([f0ec73d](https://github.com/maarten-k/snakemake/commit/f0ec73d2470d3ecf1d8500b52fa86021463a96fe))
* always deploy conda envs in main process when assuming a shared file system (fixes issue [#1463](https://github.com/maarten-k/snakemake/issues/1463)) ([#1472](https://github.com/maarten-k/snakemake/issues/1472)) ([79788eb](https://github.com/maarten-k/snakemake/commit/79788eb5e8bd404e507ef7e54a0caa6103d90c4e))
* always make sure that the original path of source cached files is properly passed into metadata persistence records ([#2179](https://github.com/maarten-k/snakemake/issues/2179)) ([8bacbd0](https://github.com/maarten-k/snakemake/commit/8bacbd0b19b0e372f5840b1fab838b79a6bab557))
* always recalculate job resources before job is scheduled as input might have changed or not have been present initially ([#1552](https://github.com/maarten-k/snakemake/issues/1552)) ([44aacdb](https://github.com/maarten-k/snakemake/commit/44aacdbb35879e1d7914aa105401541465387955))
* always wait for input files before starting jobs, also upon local execution and within group jobs. This should add further robustness against NFS latency issues. ([#1486](https://github.com/maarten-k/snakemake/issues/1486)) ([cab2adb](https://github.com/maarten-k/snakemake/commit/cab2adbc2278a2c1689414d2a3f172bb1d5c84d1))
* assume shared filesystem by default when running with --flux ([#2075](https://github.com/maarten-k/snakemake/issues/2075)) ([4bec2fd](https://github.com/maarten-k/snakemake/commit/4bec2fd3bb0c48a1f38506a966cb64dc8c2d1021))
* atomic job error display ([#1326](https://github.com/maarten-k/snakemake/issues/1326)) ([aa2c265](https://github.com/maarten-k/snakemake/commit/aa2c2652608d3e95ad7fb568df09ef1ae09e1def))
* avoid "Admin" prompt when using conda on windows ([#1046](https://github.com/maarten-k/snakemake/issues/1046)) ([552fadf](https://github.com/maarten-k/snakemake/commit/552fadf7d0ea0f0ff3990295db2618a31c692f61))
* avoid erroneous too early deletion of parent directories in case of failed jobs (thanks to @SichongP). ([#1601](https://github.com/maarten-k/snakemake/issues/1601)) ([b0917e6](https://github.com/maarten-k/snakemake/commit/b0917e6f07e356764880632495ec3567ec8555b4))
* avoid incomplete remote files in case of errors and automatically retry download and upload ([#1432](https://github.com/maarten-k/snakemake/issues/1432)) ([8fc23ed](https://github.com/maarten-k/snakemake/commit/8fc23ed09f9c6de7519160797584ff9df3104939))
* avoid logfile writing in case of dryrun; better hints in case of incomplete checkpoints ([#1994](https://github.com/maarten-k/snakemake/issues/1994)) ([a022705](https://github.com/maarten-k/snakemake/commit/a022705db14c9409b1ceadf6d5ae6367833e2131))
* avoid mutable default argument ([#1330](https://github.com/maarten-k/snakemake/issues/1330)) ([978cc93](https://github.com/maarten-k/snakemake/commit/978cc9327ce7deb517ad609977e1ce432c58c5e2))
* batch collect jobs for scancel ([#2114](https://github.com/maarten-k/snakemake/issues/2114)) ([0b1fe31](https://github.com/maarten-k/snakemake/commit/0b1fe312e8c98a814b1c419940f35253f58f958e))
* better error message in case of failing to create conda env ([#1526](https://github.com/maarten-k/snakemake/issues/1526)) ([e7a461c](https://github.com/maarten-k/snakemake/commit/e7a461ce7b5626e603784da27aa4c87649f5edec))
* better error messages in case of missing files after latency period ([#1528](https://github.com/maarten-k/snakemake/issues/1528)) ([5b394c0](https://github.com/maarten-k/snakemake/commit/5b394c0319cfc5f8000b616d0f3c911a9091d05b))
* better job status queries for slurm executor  ([#2136](https://github.com/maarten-k/snakemake/issues/2136)) ([a4df38c](https://github.com/maarten-k/snakemake/commit/a4df38c56e935dde9c2745bed6afc13e1fed671f))
* bug in pipe group handling that led to multiple assignments of the same group id to different groups; bug that accidentally added already running groups of the list of ready jobs (issue [#1331](https://github.com/maarten-k/snakemake/issues/1331)) ([#1332](https://github.com/maarten-k/snakemake/issues/1332)) ([1a9b483](https://github.com/maarten-k/snakemake/commit/1a9b483a6c675315d74bff791502c2bdd74609c1))
* Bump yte from &gt;=1.0,&lt;2.0 to >=1.5.1,<2.0 ([#2275](https://github.com/maarten-k/snakemake/issues/2275)) ([8c0b34f](https://github.com/maarten-k/snakemake/commit/8c0b34f869e4f65ff2e47cf5f1e2863bd104f8e7))
* catch errors in remote.AUTO provider list ([#1834](https://github.com/maarten-k/snakemake/issues/1834)) ([c613ed2](https://github.com/maarten-k/snakemake/commit/c613ed217f1dfb16fc63fa7b06af4ddf4f3dd0b8))
* Catch missing error stream in Slurm executor ([#2063](https://github.com/maarten-k/snakemake/issues/2063)) ([c21fc7e](https://github.com/maarten-k/snakemake/commit/c21fc7e528327b13d762c5db90ee0e40506cf0bd))
* Change ratelimiter dependency to throttler ([#1958](https://github.com/maarten-k/snakemake/issues/1958)) ([50b8f16](https://github.com/maarten-k/snakemake/commit/50b8f1609a597dc9f25d2fd86c9cdda531bdc041))
* change source cache entries to keep the original name and folder structure, such that imports from e.g. scripts also work with remote modules (if specified as additional input files with workflow.source_path) ([#1936](https://github.com/maarten-k/snakemake/issues/1936)) ([c34f3f6](https://github.com/maarten-k/snakemake/commit/c34f3f64ac19d2c2eaab361d73d3144430538bb6))
* check for skipped rules in case of local rule inheritance ([#1631](https://github.com/maarten-k/snakemake/issues/1631)) ([9083ac1](https://github.com/maarten-k/snakemake/commit/9083ac1f40daf3d284ce9b1ac2d4addde9b5b258))
* cleaned up and rewritten execution backend structure, (fixing [#1475](https://github.com/maarten-k/snakemake/issues/1475), [#860](https://github.com/maarten-k/snakemake/issues/860), [#1007](https://github.com/maarten-k/snakemake/issues/1007), [#1008](https://github.com/maarten-k/snakemake/issues/1008)) (PR [#1491](https://github.com/maarten-k/snakemake/issues/1491)) ([e87cc97](https://github.com/maarten-k/snakemake/commit/e87cc979bea0567e1cd97722d385f472857df83c))
* Comparison of rules and non-rule instances ([#1894](https://github.com/maarten-k/snakemake/issues/1894)) ([bf01ece](https://github.com/maarten-k/snakemake/commit/bf01ece0e9c51442daba02ecf2ef37aa276283d6))
* conda create --no-shortcuts absent on Linux/MacOS (regression from [#1046](https://github.com/maarten-k/snakemake/issues/1046)) ([#1916](https://github.com/maarten-k/snakemake/issues/1916)) ([8a86a1e](https://github.com/maarten-k/snakemake/commit/8a86a1e5ec7438492e2f1403b1b0fd81030255ad))
* conda python interpreter path on Windows ([#1711](https://github.com/maarten-k/snakemake/issues/1711)) ([155c9d6](https://github.com/maarten-k/snakemake/commit/155c9d6688a99db4b49c5b25d5a8a65a3aca532d))
* consider post-deploy script for env hashing   ([#1363](https://github.com/maarten-k/snakemake/issues/1363)) ([d50efd9](https://github.com/maarten-k/snakemake/commit/d50efd9d16d029fb0e5b14b182882c71a20552bb))
* Consider source cache when setting search path for python scripts. This allows to import from Python modules next to scripts while deploying the workflow as a snakemake module, even from remote locations. ([#1940](https://github.com/maarten-k/snakemake/issues/1940)) ([27be1d4](https://github.com/maarten-k/snakemake/commit/27be1d41c397a974f33dcf93ccce331a80ab0198))
* consistently use text output in conda shell commands and various little fixes for failing test cases due to conda package changes ([#1864](https://github.com/maarten-k/snakemake/issues/1864)) ([4234fe7](https://github.com/maarten-k/snakemake/commit/4234fe765e996dbb3a1738567299ebb4d8c28af0))
* convert conda env to string before checks ([#1382](https://github.com/maarten-k/snakemake/issues/1382)) ([7a8da9f](https://github.com/maarten-k/snakemake/commit/7a8da9fbf01a037a99ebaa3732fe25e87a96fcd2))
* correct handling of exceptions in input functions that are generators ([#1536](https://github.com/maarten-k/snakemake/issues/1536)) ([d9a56aa](https://github.com/maarten-k/snakemake/commit/d9a56aaf75c5f70ba0217d9d461d839fa3013f2e))
* correctly parse empty values in config cli ([#2032](https://github.com/maarten-k/snakemake/issues/2032)) ([1b0689d](https://github.com/maarten-k/snakemake/commit/1b0689dddf5eecbd8afd307c6df3dc31a32c338f))
* Correctly parse UserDicts in executors ([#2016](https://github.com/maarten-k/snakemake/issues/2016)) ([e3926fa](https://github.com/maarten-k/snakemake/commit/e3926fa4b44bedf99745b949080397919a522aa1))
* declare associative arrays ([#1844](https://github.com/maarten-k/snakemake/issues/1844)) ([90ae449](https://github.com/maarten-k/snakemake/commit/90ae44943a6b7712d46677364752bf0a7cf91806))
* delay evaluation of tmpdir to actual job execution, and not submission. This way, tmpdir can be dependent on the node context. ([#1860](https://github.com/maarten-k/snakemake/issues/1860)) ([4203556](https://github.com/maarten-k/snakemake/commit/420355662ebea0bc72c9bd6bca1eea5259f3b43e))
* Detect pandas availability to select serializer ([#2300](https://github.com/maarten-k/snakemake/issues/2300)) ([e08a771](https://github.com/maarten-k/snakemake/commit/e08a771f90aef84f3075e07c8d4e4c0f7881047c))
* disable mtime retrieval from github api for now. This quickly exceeds rate limits. ([1858bb9](https://github.com/maarten-k/snakemake/commit/1858bb912823da2021f88a9c0cdabe1ee1083575))
* display change warnings only for jobs that won't be executed otherwise ([086f60f](https://github.com/maarten-k/snakemake/commit/086f60f142721a6085b105bc4bbe12cccc9cee02))
* display wrapper or external script code in report [#1393](https://github.com/maarten-k/snakemake/issues/1393) ([#1404](https://github.com/maarten-k/snakemake/issues/1404)) ([a007bd1](https://github.com/maarten-k/snakemake/commit/a007bd11fb49a5765a643ec78e19f30b3a10dfab))
* do not apply module prefix in case of remote files ([5645b3f](https://github.com/maarten-k/snakemake/commit/5645b3f75066d8d1d8841b6e6732cd8ad098f67f))
* do not pass SNAKEMAKE_PROFILE into cluster-submit ([#1398](https://github.com/maarten-k/snakemake/issues/1398)) ([#1407](https://github.com/maarten-k/snakemake/issues/1407)) ([7189183](https://github.com/maarten-k/snakemake/commit/71891839e397130fb1af3e499d30fa9a953a93f7))
* do not remove existing temp files in case of dryrun ([#1543](https://github.com/maarten-k/snakemake/issues/1543)) ([e820f97](https://github.com/maarten-k/snakemake/commit/e820f973ad8ca99822be69c927c7d7bf6a89f54e))
* do not require --cores or --jobs to be set when --cleanup-metadata is used. ([#1429](https://github.com/maarten-k/snakemake/issues/1429)) ([9c73907](https://github.com/maarten-k/snakemake/commit/9c739079bf3e6340facaa03f88f757df36f6dd91))
* do not skip local conda env creation per se when having no shared FS, because it is still needed for local jobs. Instead, decide for each env whether it is needed locally or not. ([#1490](https://github.com/maarten-k/snakemake/issues/1490)) ([3f03c5d](https://github.com/maarten-k/snakemake/commit/3f03c5d303fbdd9e05aa13a4d93bce08cade32b2))
* do not wait for named or containerized conda envs ([#1473](https://github.com/maarten-k/snakemake/issues/1473)) ([6b1d09c](https://github.com/maarten-k/snakemake/commit/6b1d09c1e270348e8ef77d6ad8c24e1ca540215c))
* do not wrap whitespace in result info headers of reports ([653d0d0](https://github.com/maarten-k/snakemake/commit/653d0d0b92d2556e0fa04a8208f37fd982dcb829))
* don't raise WorkflowError when entry is empty ([#1368](https://github.com/maarten-k/snakemake/issues/1368)) ([1fc6f7b](https://github.com/maarten-k/snakemake/commit/1fc6f7b5d7e7d7f40baab961db89c4b59c950bf7))
* Draft notebook filename with wildcards and params. ([#1352](https://github.com/maarten-k/snakemake/issues/1352)) ([11d4dc8](https://github.com/maarten-k/snakemake/commit/11d4dc88598ffb901450bd4e076b91f4e27d37b0))
* ensure that rule inheritance considers the same globals and other settings as parent module ([#1621](https://github.com/maarten-k/snakemake/issues/1621)) ([104cab9](https://github.com/maarten-k/snakemake/commit/104cab97d9e1a7dda4c9948efa5883d5478d2229))
* ensure that rule name string instead of object is passed to tabulate package ([#1898](https://github.com/maarten-k/snakemake/issues/1898)) ([f9ff157](https://github.com/maarten-k/snakemake/commit/f9ff157c5c534ba035bdf51a02fbbba5ad94dd61))
* ensure user and group rw permissions for metadata files and source cache ([#2132](https://github.com/maarten-k/snakemake/issues/2132)) ([cc51faa](https://github.com/maarten-k/snakemake/commit/cc51faaa7d4f20896fc46b9fd67d062936d641bb))
* ensures that REncoder also checks for numpy.bool_ in encode_value ([#1749](https://github.com/maarten-k/snakemake/issues/1749)) ([10a6e1d](https://github.com/maarten-k/snakemake/commit/10a6e1de50ea7957e8685ba55b2cc115101cc23f))
* fail with error if conda installation is not set to strict channel priorities ([#1672](https://github.com/maarten-k/snakemake/issues/1672)) ([f1ffbf2](https://github.com/maarten-k/snakemake/commit/f1ffbf28f04150c6e66297f242b768a22f80bd94))
* failure to properly apply default remote prefix in combination with the unpack marker ([#1448](https://github.com/maarten-k/snakemake/issues/1448)) ([82666f1](https://github.com/maarten-k/snakemake/commit/82666f1b2b043f0a8de739d7027aba66eccdaee3))
* fix `--immediate-submit` ([#1851](https://github.com/maarten-k/snakemake/issues/1851)) ([e358372](https://github.com/maarten-k/snakemake/commit/e3583721f2dc620ce96876ecec58846d1cbe7bfd))
* fix a bug leading to duplicate conda env initializations; fix display of jobs and output files with changes ([994b151](https://github.com/maarten-k/snakemake/commit/994b1510766083df7f22d10c0e6e4bb65ffdd710))
* fix assertion error in conda env file spec when applying wildcards (thanks [@ddesvillechabrol](https://github.com/ddesvillechabrol)) ([#1377](https://github.com/maarten-k/snakemake/issues/1377)) ([6200652](https://github.com/maarten-k/snakemake/commit/6200652b9aff2362a63581cee58eb9f9cae189da))
* Fix case of multiple scattergather processes ([#1799](https://github.com/maarten-k/snakemake/issues/1799)) ([417aad4](https://github.com/maarten-k/snakemake/commit/417aad4c1a5fe83bdf24729d0d4e70df112fd293))
* fix errors occurring when refering to input func via rules.&lt;rulename&gt;.input ([#1669](https://github.com/maarten-k/snakemake/issues/1669)) ([28a4795](https://github.com/maarten-k/snakemake/commit/28a47959bca2d135f82f9d8901b2b0aa228f30cb))
* fix false rerun triggering downstream of checkpoints due to spurious parameter, code or software env changes ([638ea86](https://github.com/maarten-k/snakemake/commit/638ea86c51ea5746c8b5452cc8a0e43108de15ef))
* fix false reruns after checkpoints ([#1907](https://github.com/maarten-k/snakemake/issues/1907)) ([dc5af12](https://github.com/maarten-k/snakemake/commit/dc5af12f54e774612bb1f8ead45e4597080dc100))
* fix falsely triggered reruns if input files are obtained via workflow.source_path() ([#1862](https://github.com/maarten-k/snakemake/issues/1862)) ([2dc2e6a](https://github.com/maarten-k/snakemake/commit/2dc2e6aa3255b8b73e06b7af1ea646d5081799ce))
* Fix handling of --jobs in no-exec state ([#2029](https://github.com/maarten-k/snakemake/issues/2029)) ([e8e8222](https://github.com/maarten-k/snakemake/commit/e8e8222a6f2192423aa55766304f9d1616a0d6e3))
* Fix inconsistencies between detailed summary and normal summary ([#2218](https://github.com/maarten-k/snakemake/issues/2218)) ([d903123](https://github.com/maarten-k/snakemake/commit/d9031236563b7dd8e31ed27208c9ad39699f765e))
* fix index out of bounds error raised by usage of workflow.source_path called from input or params functions (thanks @AKBrueggemann) ([#2170](https://github.com/maarten-k/snakemake/issues/2170)) ([cf8e6e8](https://github.com/maarten-k/snakemake/commit/cf8e6e8995ecb4371c179851f4ded1d01cd1b7f9))
* fix issue when generating unit tests for rules with directory output ([#1385](https://github.com/maarten-k/snakemake/issues/1385)) ([7db614f](https://github.com/maarten-k/snakemake/commit/7db614fa1753179d2cdc20095df17d5ac2885ad0))
* fix missed wildcard constraints when using local rule inheritance ([#2242](https://github.com/maarten-k/snakemake/issues/2242)) ([8e94785](https://github.com/maarten-k/snakemake/commit/8e947858dd510cb4c813f24093b5be843fa4cf6c))
* fix None type error when invoking Workflow object manually ([#1366](https://github.com/maarten-k/snakemake/issues/1366)) ([fca3895](https://github.com/maarten-k/snakemake/commit/fca3895430c206fc159e71622ee567f77566980d))
* fix pandas import handling in metadata persistence ([27f7b40](https://github.com/maarten-k/snakemake/commit/27f7b4014eaea66aa4e599aa854dda75822d30a0))
* fix pepfile handling in case of module usage ([#1387](https://github.com/maarten-k/snakemake/issues/1387)) ([f097a76](https://github.com/maarten-k/snakemake/commit/f097a761472248d779113cdb22b5274395828bcb))
* Fix race condition when creating lock directory ([#2225](https://github.com/maarten-k/snakemake/issues/2225)) ([66ea4d1](https://github.com/maarten-k/snakemake/commit/66ea4d199e3d9266b1b5fdb8752772e8137ffdea))
* fix regression in workflow source acquisition of google life science executor ([#1773](https://github.com/maarten-k/snakemake/issues/1773)) ([c07732e](https://github.com/maarten-k/snakemake/commit/c07732e2c7d6e95fabb3f2570bf0a1b0af2ac2cb))
* fix scrolling behavior in landing page of report for large workflows ([63c0c31](https://github.com/maarten-k/snakemake/commit/63c0c31c222a921a843d83e330a6f91e430f209a))
* fix singularity logging messages causing conda fail ([#1523](https://github.com/maarten-k/snakemake/issues/1523)) ([7797595](https://github.com/maarten-k/snakemake/commit/77975952ce7df346729f76a767ad4f475b385306))
* fix source cache handling for remote source files retrieved via github() or gitlab() tags. ([#1322](https://github.com/maarten-k/snakemake/issues/1322)) ([6e2ecd2](https://github.com/maarten-k/snakemake/commit/6e2ecd26e48eb64fa04c9c38dde591857e03c722))
* Fix technical bugs in resource-scope documentation ([#1784](https://github.com/maarten-k/snakemake/issues/1784)) ([878420c](https://github.com/maarten-k/snakemake/commit/878420c4496562df7fe5fed4e6f877e670dcd533))
* fix typo in line display of exceptions ([#1912](https://github.com/maarten-k/snakemake/issues/1912)) ([55e38a6](https://github.com/maarten-k/snakemake/commit/55e38a6f80c74b24d7763975b0ae2826d75f23d9))
* fixed bug in missing input file handling for cluster jobs ([#1544](https://github.com/maarten-k/snakemake/issues/1544)) ([40e2eb2](https://github.com/maarten-k/snakemake/commit/40e2eb2e6c6e31c7cc590c8d643e0640e9377aa4))
* fixed bug in needrun computation of jobs downsteam of checkpoints ([#1704](https://github.com/maarten-k/snakemake/issues/1704)) ([c634b78](https://github.com/maarten-k/snakemake/commit/c634b78b4d7c4f6ef59e46c94162893e42de6f73))
* fixed code change detection ([#1513](https://github.com/maarten-k/snakemake/issues/1513)) ([67298c6](https://github.com/maarten-k/snakemake/commit/67298c6167ccaef5f9fbd03ec6b4fe65d86e9ca3))
* fixed conda frontend detection and checking to also work with latest mambaforge ([#1781](https://github.com/maarten-k/snakemake/issues/1781)) ([225e68c](https://github.com/maarten-k/snakemake/commit/225e68cb05ecbf8fe001a884a416da0239cfd4d1))
* fixed detection of norun rules inside of modules ([#1566](https://github.com/maarten-k/snakemake/issues/1566)) ([d2223d4](https://github.com/maarten-k/snakemake/commit/d2223d41dfba057ab735395eac8339c27866c2ae))
* fixed display of any exceptions and errors from within a workflow definition ([23d40d9](https://github.com/maarten-k/snakemake/commit/23d40d99614a88fd3c596d05e6915509ae43d4ce))
* fixed handling of input functions and unpack when using the prefix setting of module definitions ([#1553](https://github.com/maarten-k/snakemake/issues/1553)) ([d561e04](https://github.com/maarten-k/snakemake/commit/d561e041a8919717046be0d39f197b2c6b937cb7))
* fixed parsing of subsequent use rule statements directly beneath each other ([#1548](https://github.com/maarten-k/snakemake/issues/1548)) ([77d5a08](https://github.com/maarten-k/snakemake/commit/77d5a08ab49d67b8cbd8ea4b6b6b7792edb38e3b))
* fixed permission issues when using zenodo remote provider to access restricted depositions ([#1634](https://github.com/maarten-k/snakemake/issues/1634)) ([510f534](https://github.com/maarten-k/snakemake/commit/510f534ff55635e5c3ca677e0ccd8c5b5dd7ca0f))
* fixed problem with leaked modifications when inheriting multiple times from the same rule ([#1957](https://github.com/maarten-k/snakemake/issues/1957)) ([2475cbc](https://github.com/maarten-k/snakemake/commit/2475cbcd74d9c9f62e07617751979bb00025850a))
* fixed temp file deletion for group jobs ([#1487](https://github.com/maarten-k/snakemake/issues/1487)) ([d030443](https://github.com/maarten-k/snakemake/commit/d030443548a9851a82bcce618b24a9e24a8b545d))
* fixed typos ([#1847](https://github.com/maarten-k/snakemake/issues/1847)) ([a1e49b6](https://github.com/maarten-k/snakemake/commit/a1e49b6f290daeb2012575ab3a85ca72cfe42747))
* forwarding --keep-incomplete to cluster executor ([#1951](https://github.com/maarten-k/snakemake/issues/1951)) ([2894c7d](https://github.com/maarten-k/snakemake/commit/2894c7dfaa854ebe34b1248897c90b4110d3962b))
* get python version for script environment in a backwards compatible way that works down to python 2.7 ([#2161](https://github.com/maarten-k/snakemake/issues/2161)) ([44e59b9](https://github.com/maarten-k/snakemake/commit/44e59b9baa0842e19c5e0f2e05cf2fe5c9f47790))
* handle benmark bug that arise with singularity ([#1671](https://github.com/maarten-k/snakemake/issues/1671)) ([10ef7c4](https://github.com/maarten-k/snakemake/commit/10ef7c4d1cbbd89fa1760ec9f643e09ae4eb8bd9))
* handle case where zenodo deposition does not return files ([#2004](https://github.com/maarten-k/snakemake/issues/2004)) ([b63c4a7](https://github.com/maarten-k/snakemake/commit/b63c4a7e496ca7a3353e8a59b8ba493d65156cb5))
* Handle temp files for all jobs in a group. ([#1779](https://github.com/maarten-k/snakemake/issues/1779)) ([d28b893](https://github.com/maarten-k/snakemake/commit/d28b89363f007d303d733b2b12f517502867035c))
* handling of remaining jobs when using --keep-going ([#1693](https://github.com/maarten-k/snakemake/issues/1693)) ([87e4303](https://github.com/maarten-k/snakemake/commit/87e430354b45c702e4d782bad8461fde44477a48))
* implement lock-free source file caching. This avoids hangs on network file systems like NFS. ([#1464](https://github.com/maarten-k/snakemake/issues/1464)) ([9520e98](https://github.com/maarten-k/snakemake/commit/9520e988a32f0c5369b4f2c68fdb741f21daa1a4))
* improve robustness when retrieving remote source files, fixed usage of local git repos as wrapper prefixes (in collaboration with [@cokelaer](https://github.com/cokelaer) and @Smeds) ([#1495](https://github.com/maarten-k/snakemake/issues/1495)) ([e16531d](https://github.com/maarten-k/snakemake/commit/e16531d6d35b5eb3f7d19008e3e9c4432c4b2e69))
* improved default resources parsing (also allowing to deactivate a default resource via setting it to None) ([#2006](https://github.com/maarten-k/snakemake/issues/2006)) ([e6cdb32](https://github.com/maarten-k/snakemake/commit/e6cdb32fd20a9899f441b3ec8aca3f36710f7a4a))
* improved provenance trigger info ([#1720](https://github.com/maarten-k/snakemake/issues/1720)) ([29d959d](https://github.com/maarten-k/snakemake/commit/29d959d86341aee66e945f216cae41e9c531a4d1))
* in google live science backend, save multiple logs per rule name and overwrite existing logs ([#1504](https://github.com/maarten-k/snakemake/issues/1504)) ([9e92d63](https://github.com/maarten-k/snakemake/commit/9e92d63b9e68b29ccd680c34171994b0a2041efb))
* in rules from imported modules, exclude modified paths from module prefixing ([#1494](https://github.com/maarten-k/snakemake/issues/1494)) ([1e73db0](https://github.com/maarten-k/snakemake/commit/1e73db0325f407529108acc689a915ff23611b5a))
* iRODS functionality - issue [#1510](https://github.com/maarten-k/snakemake/issues/1510) ([#1611](https://github.com/maarten-k/snakemake/issues/1611)) ([9c3767d](https://github.com/maarten-k/snakemake/commit/9c3767d6ee13a2c149a4ffe1c0547cabec0346dd))
* is_run error with local, group jobs ([#2133](https://github.com/maarten-k/snakemake/issues/2133)) ([31bfcd5](https://github.com/maarten-k/snakemake/commit/31bfcd5399540fc6cf52e3b76144e9abea6d4eab))
* issue [#1882](https://github.com/maarten-k/snakemake/issues/1882) WorkflowError: Metadata can't be created as it already exists (Windows) ([#1971](https://github.com/maarten-k/snakemake/issues/1971)) ([d4484e6](https://github.com/maarten-k/snakemake/commit/d4484e61ef49be23fc2bef8bf879185e521f5376))
* issue 1615 - Switch formatting condition for dictionary ([#1617](https://github.com/maarten-k/snakemake/issues/1617)) ([0771062](https://github.com/maarten-k/snakemake/commit/0771062a07f0e2cfe9ee45a2276aa61b096eb6e1))
* issue 1846 ([#1888](https://github.com/maarten-k/snakemake/issues/1888)) ([da2dfbd](https://github.com/maarten-k/snakemake/commit/da2dfbd765aa1e2a8da36d9eaa1ac9fcffa5e921))
* issue with duplicated prefix for checkpoints on cloud ([#1294](https://github.com/maarten-k/snakemake/issues/1294)) ([8ed0c8c](https://github.com/maarten-k/snakemake/commit/8ed0c8cb453b6ebf6df138391a0681ffc8442e09))
* issue1460 intermediate files existing (or not) ([#1541](https://github.com/maarten-k/snakemake/issues/1541)) ([1b3ede1](https://github.com/maarten-k/snakemake/commit/1b3ede19159856a982de65e6293ab064c0987352))
* json validation error with markdown cells ([#1986](https://github.com/maarten-k/snakemake/issues/1986)) ([6c26f75](https://github.com/maarten-k/snakemake/commit/6c26f757785226d796c80689fabae771f316af9f))
* k8s container volume mounts as list ([#1868](https://github.com/maarten-k/snakemake/issues/1868)) ([5c54df3](https://github.com/maarten-k/snakemake/commit/5c54df39c6a111dcfa7adaea15d0b81a3fc16b90))
* keep flags with apply_wildcards on cloned IOFile ([#1416](https://github.com/maarten-k/snakemake/issues/1416)) ([23c943f](https://github.com/maarten-k/snakemake/commit/23c943f0e285f2dc725aa3e4a2e8798021085cb3))
* lexicographically sorted rule display with --list, and trimmed rule docstrings ([#1880](https://github.com/maarten-k/snakemake/issues/1880)) ([32128ae](https://github.com/maarten-k/snakemake/commit/32128ae118d15f250e4b438735e30151cd6f27c5))
* limit filename length of temporary files generated by the persistence backend (metadata, incomplete markers, etc.) ([#1780](https://github.com/maarten-k/snakemake/issues/1780)) ([59053e7](https://github.com/maarten-k/snakemake/commit/59053e7017584ea94860cecb5ebecce66aed14ce))
* limit length of failed logs decorations ([#2125](https://github.com/maarten-k/snakemake/issues/2125)) ([6fc9243](https://github.com/maarten-k/snakemake/commit/6fc92434f5aaed60c3d1e62bf4d33c68eeb6ed53))
* make `--show-failed-logs` handle empty log files ([#2039](https://github.com/maarten-k/snakemake/issues/2039)) ([683c6f2](https://github.com/maarten-k/snakemake/commit/683c6f2284e867457d7ed25e838ed3018da8f2d4)), closes [#2023](https://github.com/maarten-k/snakemake/issues/2023)
* make python version check more robust ([#2058](https://github.com/maarten-k/snakemake/issues/2058)) ([e685621](https://github.com/maarten-k/snakemake/commit/e685621f3b4c0e21aa6f640dd571406d1d39e588))
* modify dag and workflow display in report to also work for big DAGs ([#1517](https://github.com/maarten-k/snakemake/issues/1517)) ([1364dfb](https://github.com/maarten-k/snakemake/commit/1364dfbc9db58541aaf5600bca61230f9eb4ecbc))
* more comprehensive error reporting for RuleExceptions ([#1802](https://github.com/maarten-k/snakemake/issues/1802)) ([1cd9512](https://github.com/maarten-k/snakemake/commit/1cd95129a92e522e11689620473f68b1fe69fb42))
* more details on input and output exceptions (missing input, protected output, etc.) ([#1453](https://github.com/maarten-k/snakemake/issues/1453)) ([8d64af2](https://github.com/maarten-k/snakemake/commit/8d64af2cb905fef95585055c7b69fd1c45d44108))
* more robust calculation of number of jobs until ready for execution ([#1691](https://github.com/maarten-k/snakemake/issues/1691)) ([fdfc717](https://github.com/maarten-k/snakemake/commit/fdfc717f8764ce535801d06805aaa1d59186ec84))
* more robust encoding of params in persistent metadata storage. This way, pandas parameters do not lead to spurious rerun triggers. ([#2080](https://github.com/maarten-k/snakemake/issues/2080)) ([106a4c3](https://github.com/maarten-k/snakemake/commit/106a4c3f4b181d787a6c309b8ea2e655780413e7))
* more robust handling of incompletely evaluated parameters (any interaction with them will result in a string &lt;TBD&gt; now). ([#1525](https://github.com/maarten-k/snakemake/issues/1525)) ([3d4c768](https://github.com/maarten-k/snakemake/commit/3d4c768aafbdca67a9032ad9e3b73449a1fadb0d))
* more robust parsing of sacct output in slurm executor ([#2036](https://github.com/maarten-k/snakemake/issues/2036)) ([fe651f8](https://github.com/maarten-k/snakemake/commit/fe651f8a10b9ead94b07ab31efe2d560525fc3b6))
* more robust place for runtime source file cache ([#1436](https://github.com/maarten-k/snakemake/issues/1436)) ([2681f6f](https://github.com/maarten-k/snakemake/commit/2681f6f163832dfa5214e10f5234d256f5a13407))
* move max_status_checks_per_second attribute setting before the wait thread of cluster backends is started to avoid missing attribute errors ([#1775](https://github.com/maarten-k/snakemake/issues/1775)) ([a48e9d0](https://github.com/maarten-k/snakemake/commit/a48e9d035efec3a91b50bbda43ddf92196d5084b))
* Move quiet default after profile parsing ([#1764](https://github.com/maarten-k/snakemake/issues/1764)) ([6ade76d](https://github.com/maarten-k/snakemake/commit/6ade76d1287c8f62056853491a4e67b08a4739a6))
* mtime inventory for google storage was accidentally setting a float instead of a proper mtime object ([#1484](https://github.com/maarten-k/snakemake/issues/1484)) ([7c762c7](https://github.com/maarten-k/snakemake/commit/7c762c7e5204f95ca85157ba5fe5ab061b8abdfa))
* multiext prefix computation in case it is used within a module that defines an additional prefix ([#1609](https://github.com/maarten-k/snakemake/issues/1609)) ([fc6dfc6](https://github.com/maarten-k/snakemake/commit/fc6dfc6469137a82382a36b9469190d967593759))
* None type error when invoking Workflow object manually ([#1731](https://github.com/maarten-k/snakemake/issues/1731)) ([dc45ccb](https://github.com/maarten-k/snakemake/commit/dc45ccb9ee94e8fcdf386c8598bbae57e319ba10))
* obtaining conda prefix when using in combination with singularity ([#1535](https://github.com/maarten-k/snakemake/issues/1535)) ([99b22d3](https://github.com/maarten-k/snakemake/commit/99b22d33f2100a7e4cf2d080a2272959a712d055))
* only consider global wildcard_constraints from the same module ([#2235](https://github.com/maarten-k/snakemake/issues/2235)) ([c412b71](https://github.com/maarten-k/snakemake/commit/c412b714a9fbe5cad9ad30de4a0b78b3c13068f6))
* only display a warning in case of non-strict channel priorities ([#1752](https://github.com/maarten-k/snakemake/issues/1752)) ([b84fa33](https://github.com/maarten-k/snakemake/commit/b84fa337f5c417360fc744202a419da3f37594b5))
* Open Snakefile for reading with explicit encoding specified ([#1146](https://github.com/maarten-k/snakemake/issues/1146)) ([ec1d859](https://github.com/maarten-k/snakemake/commit/ec1d859dd2422fa551bbf58843907fc5eed244ff))
* parsing error when combining single line directive with multi-line directive in use rule statements ([#1662](https://github.com/maarten-k/snakemake/issues/1662)) ([26e57d6](https://github.com/maarten-k/snakemake/commit/26e57d69fc320adc972967a8046c5163b455456c))
* parsing error when last line is comment ([#2054](https://github.com/maarten-k/snakemake/issues/2054)) ([a928dd4](https://github.com/maarten-k/snakemake/commit/a928dd4391d186b6ddb582331047f09fbee03f03))
* pass triggers and resources to subworkflow ([#1733](https://github.com/maarten-k/snakemake/issues/1733)) ([fa7fb75](https://github.com/maarten-k/snakemake/commit/fa7fb75d2314cd2965a9f578506e27aae4b07349))
* Postprocess job groups in toposorted order for correct touch times ([#2073](https://github.com/maarten-k/snakemake/issues/2073)) ([10b5849](https://github.com/maarten-k/snakemake/commit/10b584916a869fa1147a9f42d1de4fec4120b441))
* preserve dtypes across paramspace ([#1578](https://github.com/maarten-k/snakemake/issues/1578)) ([70ce6a0](https://github.com/maarten-k/snakemake/commit/70ce6a0feb8572ddcf888c3d377d631ea4a24370))
* preserve empty names input or output file lists in params or resource functions ([0d19ab0](https://github.com/maarten-k/snakemake/commit/0d19ab0e6fcabe61b49d5ef9f2b293b9bcc06534))
* prevent overriding of retries when set to 0 ([#2053](https://github.com/maarten-k/snakemake/issues/2053)) ([a328f3e](https://github.com/maarten-k/snakemake/commit/a328f3e009a53002781539dfe3e3c8c5d1738189))
* prevents DeprecationWarning caused by using old  draft of json schema ([#2152](https://github.com/maarten-k/snakemake/issues/2152)) ([9791ffb](https://github.com/maarten-k/snakemake/commit/9791ffb978a6d09d90d311cc98363c4d4efc2042))
* propagate attempt count from group to subjobs ([#2052](https://github.com/maarten-k/snakemake/issues/2052)) ([da3f1c0](https://github.com/maarten-k/snakemake/commit/da3f1c0a80ffabbe9d02ce1361bfa2374c546007))
* propagate rerun trigger info to cluster jobs; fix a bug leading to software stack trigger generating false positives in case of conda environments; fixed display of info message in case of provenance triggered reruns ([#1686](https://github.com/maarten-k/snakemake/issues/1686)) ([503c70c](https://github.com/maarten-k/snakemake/commit/503c70c7727e154f8fadf6ead088887d22a87a65))
* proper error message if resource types do not match ([#1556](https://github.com/maarten-k/snakemake/issues/1556)) ([1112321](https://github.com/maarten-k/snakemake/commit/11123213188672a3b6e5acfffed18d9e0ccc8819))
* proper error message in case of missing git when checking for source files ([#1534](https://github.com/maarten-k/snakemake/issues/1534)) ([92887a3](https://github.com/maarten-k/snakemake/commit/92887a33dc3674f942bd0355edfbba53b810f18f))
* proper error message when defining cache eligibility for rules with multiple output files and no multiext declaration. ([#1357](https://github.com/maarten-k/snakemake/issues/1357)) ([47b5096](https://github.com/maarten-k/snakemake/commit/47b5096ebbdd3d94a9c99b443064b1b0de389c64))
* properly handle NA values for paramspaces ([#2098](https://github.com/maarten-k/snakemake/issues/2098)) ([6b6a880](https://github.com/maarten-k/snakemake/commit/6b6a88074eac6e3a9aa8c89501fc9481f07ecc1d))
* properly use configfiles specified via CLI also if configfile specified via configfile directive is not present ([1e0649a](https://github.com/maarten-k/snakemake/commit/1e0649ac37176a68bb2d8f4d1508ac8bb02463ff))
* properly use retry mechanism in source cache ([#1564](https://github.com/maarten-k/snakemake/issues/1564)) ([624a83d](https://github.com/maarten-k/snakemake/commit/624a83d1bfc592a2a1878d5191e09f6c3d7ee7c2))
* provide details on error when failing to evaluate default resources ([#1430](https://github.com/maarten-k/snakemake/issues/1430)) ([04f39a9](https://github.com/maarten-k/snakemake/commit/04f39a92f58c21265d859666bd63fe686e1d61f5))
* provide proper error when using immediate submit in combination with checkpoint jobs. ([#1437](https://github.com/maarten-k/snakemake/issues/1437)) ([865cf0f](https://github.com/maarten-k/snakemake/commit/865cf0f22656e22cd2450e5537421ce70c1705f9))
* quote jobid passed to status script to support multi-cluster Slurm setup ([#1459](https://github.com/maarten-k/snakemake/issues/1459)) ([0232201](https://github.com/maarten-k/snakemake/commit/023220160c6146810e3da2b277439441e8af9827))
* quote paths given to singularity in order to ensure that it does not fail when paths contain whitespace ([#2190](https://github.com/maarten-k/snakemake/issues/2190)) ([a572fb7](https://github.com/maarten-k/snakemake/commit/a572fb7b8f00e39723cd98d6936f63171b26c8d9))
* quote workdir in job exec prefix to allow to spaces in the workdir ([#1547](https://github.com/maarten-k/snakemake/issues/1547)) ([c3a593e](https://github.com/maarten-k/snakemake/commit/c3a593e8f7fc8e0dccec4e025f4cd9743bd80bc3))
* raise error if callable is passed to expand. ([#2171](https://github.com/maarten-k/snakemake/issues/2171)) ([1f28476](https://github.com/maarten-k/snakemake/commit/1f28476c35dc15a04e1032139b9dab5779801235))
* reduce resource requirements for kubernetes tests ([#1876](https://github.com/maarten-k/snakemake/issues/1876)) ([cb4b78a](https://github.com/maarten-k/snakemake/commit/cb4b78a05ee08f7dafb561ba33bbe460ec097eb5))
* regression ValueError introduced with 7.17.2 ([#1947](https://github.com/maarten-k/snakemake/issues/1947)) ([53a4fca](https://github.com/maarten-k/snakemake/commit/53a4fca8c67a3b58d61b146c8cfff3982889d77d))
* remove accidental pdb statement ([9c935f1](https://github.com/maarten-k/snakemake/commit/9c935f1566b976392393aeb00acf0e39eb159e19))
* remove deprecated and add missing arguments to internal functions ([93a7e39](https://github.com/maarten-k/snakemake/commit/93a7e39d9f225fac5ff5cb8cbe14500a09986ab3))
* remove overflow from rulegraph div in report ([9a0aaa7](https://github.com/maarten-k/snakemake/commit/9a0aaa703d6531d890b7116638dc515425f6ed34))
* remove raise that limits using --config with dicts ([#1341](https://github.com/maarten-k/snakemake/issues/1341)) ([bd65057](https://github.com/maarten-k/snakemake/commit/bd65057a782355ede86ad0bb912e063ff25a97f5))
* remove redundant dot in expand call in multiext documentation ([#1921](https://github.com/maarten-k/snakemake/issues/1921)) ([278beaa](https://github.com/maarten-k/snakemake/commit/278beaa7c81b9e418fa42ac5f944e3d7e2cdfbbd))
* remove redundant print ([#1608](https://github.com/maarten-k/snakemake/issues/1608)) ([cc7e0e3](https://github.com/maarten-k/snakemake/commit/cc7e0e3605bd65ffcb2d055e69761ff7337588ae))
* remove superfluous comma causing TypeError in conda-frontend error message ([#1804](https://github.com/maarten-k/snakemake/issues/1804)) ([87b013c](https://github.com/maarten-k/snakemake/commit/87b013cbba420b71892ab9f482718c1cd59e6bda))
* remove superfluous dependency ([aad61a0](https://github.com/maarten-k/snakemake/commit/aad61a0131d7ca0f7393af23b98b1db702cd976d))
* render empty caption if nothing defined in report flag ([013a6e8](https://github.com/maarten-k/snakemake/commit/013a6e8459d0659e05546c849f84151860686004))
* Repair MREs from [#823](https://github.com/maarten-k/snakemake/issues/823) ([#1203](https://github.com/maarten-k/snakemake/issues/1203)) ([b007979](https://github.com/maarten-k/snakemake/commit/b0079791718a390d1f920df15a405cf633314312))
* Replaced pathlib relative_to with os.relpath ([#1505](https://github.com/maarten-k/snakemake/issues/1505)) ([dc65e29](https://github.com/maarten-k/snakemake/commit/dc65e2921163e9b069c13f79dc0488be21452905))
* report error and possible cause if metadata cleanup fails ([#1554](https://github.com/maarten-k/snakemake/issues/1554)) ([6866134](https://github.com/maarten-k/snakemake/commit/68661341efa0a3de4e03de3fb1b8f3117de66efe))
* report spacing ([f3954b3](https://github.com/maarten-k/snakemake/commit/f3954b33536314e6a252c044eee5f424dd234065))
* request disk_mb resource from k8s ([#1858](https://github.com/maarten-k/snakemake/issues/1858)) ([f68f166](https://github.com/maarten-k/snakemake/commit/f68f166582abaeb45a1a093306626bb8abb0e0bb))
* require toposort &gt;= 1.10 ([#2145](https://github.com/maarten-k/snakemake/issues/2145)) ([3cb54b8](https://github.com/maarten-k/snakemake/commit/3cb54b8c62743897f20feb3fcf269a7357878434))
* respect shebang lines in post-deploy scripts (see deployment docs) ([#1841](https://github.com/maarten-k/snakemake/issues/1841)) ([c26c4b6](https://github.com/maarten-k/snakemake/commit/c26c4b6ff43e38797168ef7983c40b0c8a4b2f8c))
* rounding for batch calculation ([#2064](https://github.com/maarten-k/snakemake/issues/2064)) ([cbdbf9b](https://github.com/maarten-k/snakemake/commit/cbdbf9b648124422ffe16c61b776f92c33c72ef8))
* rule inheritance within modules (did previously lead to key errors) ([#1292](https://github.com/maarten-k/snakemake/issues/1292)) ([603e0a8](https://github.com/maarten-k/snakemake/commit/603e0a87d2c7af57a8f1d397605bc501c50934e0))
* set channel priority in container system wide ([#1690](https://github.com/maarten-k/snakemake/issues/1690)) ([41175b3](https://github.com/maarten-k/snakemake/commit/41175b3001ff59db5d7ea8bf91354decea04f74d))
* set default number of nodes to 1 in test cases ([#1288](https://github.com/maarten-k/snakemake/issues/1288)) ([f6e12b4](https://github.com/maarten-k/snakemake/commit/f6e12b4798485be3a1bb240b4af44d57dd5c84b2))
* set mtime for cached source files [WIP] ([#1443](https://github.com/maarten-k/snakemake/issues/1443)) ([dd27209](https://github.com/maarten-k/snakemake/commit/dd27209b4a600d3704cabc39776dfef718129197))
* show input files on job error ([#1949](https://github.com/maarten-k/snakemake/issues/1949)) ([ad21631](https://github.com/maarten-k/snakemake/commit/ad2163187f031317d889e0cbe368176e1d48d13f))
* skip global report caption when using a module ([#1379](https://github.com/maarten-k/snakemake/issues/1379)) ([a755cee](https://github.com/maarten-k/snakemake/commit/a755ceefa478d51070f926beed9090067771edf1))
* skip type checks of missing dir in touch mode ([#2051](https://github.com/maarten-k/snakemake/issues/2051)) ([ae00c25](https://github.com/maarten-k/snakemake/commit/ae00c25541600dba14ad68f1145bab3c4455de19))
* slurm batch job status queries ([#2167](https://github.com/maarten-k/snakemake/issues/2167)) ([0bb69e4](https://github.com/maarten-k/snakemake/commit/0bb69e429e161bf68b1f3e0b8f6fe3cbd6ed4dae))
* slurm default_resources quoting ([#2043](https://github.com/maarten-k/snakemake/issues/2043)) ([47d3fc3](https://github.com/maarten-k/snakemake/commit/47d3fc3eef8ebe54df8b77f100fc2ab3fa36c190))
* small bug in snakemake.executors ([#1440](https://github.com/maarten-k/snakemake/issues/1440)) ([6e64292](https://github.com/maarten-k/snakemake/commit/6e64292cfa7d5bd9f6cb786681b3710ee51abc43))
* small changes to make docs checkpoint example functional ([#1714](https://github.com/maarten-k/snakemake/issues/1714)) ([1d4909e](https://github.com/maarten-k/snakemake/commit/1d4909ef838ac79f8e7be9f29d76b969d358ef1b))
* support multiple input files for template_engine rules ([#1571](https://github.com/maarten-k/snakemake/issues/1571)) ([aee7cf2](https://github.com/maarten-k/snakemake/commit/aee7cf236611e5201feda152f5b7357b49b9f15b))
* throw error message in case of target rule that depends on a pipe. ([#1532](https://github.com/maarten-k/snakemake/issues/1532)) ([b9e9a7e](https://github.com/maarten-k/snakemake/commit/b9e9a7eff4b6e3349dde6b90eec9f5a37ef69ce7))
* typos in code examples ([#1324](https://github.com/maarten-k/snakemake/issues/1324)) ([60010e4](https://github.com/maarten-k/snakemake/commit/60010e4ef07b7ba9b89aa5f48ee90ff3cec85b75))
* Update __init__.py to move "file" param to "print" ([#2291](https://github.com/maarten-k/snakemake/issues/2291)) ([92352b6](https://github.com/maarten-k/snakemake/commit/92352b69d14ef196b0253561c78fa04ffa25d73e))
* update for minimum of Python 3.7 ([#1509](https://github.com/maarten-k/snakemake/issues/1509)) ([62024e2](https://github.com/maarten-k/snakemake/commit/62024e2bfd6d5735763f37a0f4bf43a16f229443))
* Update list of python versions in classifiers ([#2020](https://github.com/maarten-k/snakemake/issues/2020)) ([7a98100](https://github.com/maarten-k/snakemake/commit/7a98100ba92b0174c8ead3ae715042c1ab710c61))
* Use `job.rule.name` attribute to fill rule field in summary ([#2217](https://github.com/maarten-k/snakemake/issues/2217)) ([837c3fd](https://github.com/maarten-k/snakemake/commit/837c3fd97b5a16ddb4f6b74bd2c2b5479d77bd8a))
* use mambaforge for snakemake container image ([#1595](https://github.com/maarten-k/snakemake/issues/1595)) ([b7e6906](https://github.com/maarten-k/snakemake/commit/b7e6906926cae5fef6987adcf7b0294266d5faec))
* use short argument name for `--chdir` for compatibility with Slurm &lt;=v17 ([#2040](https://github.com/maarten-k/snakemake/issues/2040)) ([a9ed3ec](https://github.com/maarten-k/snakemake/commit/a9ed3ec3e823442810388fce8a17ba4950bbdaa2))
* use text/markdown for long_description_content_type ([#2112](https://github.com/maarten-k/snakemake/issues/2112)) ([0241075](https://github.com/maarten-k/snakemake/commit/02410755c51df21833199db70406b2179248380e))
* warn on non-file-modification-date changes like params, code, or input files ([#1419](https://github.com/maarten-k/snakemake/issues/1419)) ([b5f53f0](https://github.com/maarten-k/snakemake/commit/b5f53f09ae8c01e1223d2279c3a7f59819a8b44f))
* work around segfault with &gt;100 jobs in google life sciences backend ([#1451](https://github.com/maarten-k/snakemake/issues/1451)) ([2c0fee2](https://github.com/maarten-k/snakemake/commit/2c0fee2faec33185ca7fcd2276901977857e2c64))
* XRootDHelper.exists supports non posix filesystem (object store) ([#1348](https://github.com/maarten-k/snakemake/issues/1348)) ([7a3ad2f](https://github.com/maarten-k/snakemake/commit/7a3ad2f438586690dd40e4c8ec591d8c10b22b00))


### Performance Improvements

* Average NamedList __getitem__ performance improvement ([#1825](https://github.com/maarten-k/snakemake/issues/1825)) ([10451b7](https://github.com/maarten-k/snakemake/commit/10451b7198a4a39149ce5e8ec82c17df1f18813b))
* avoid superflous mtime checks when the same file is referred to by multiple jobs ([#2284](https://github.com/maarten-k/snakemake/issues/2284)) ([eb6e2e1](https://github.com/maarten-k/snakemake/commit/eb6e2e161f01c61b139d95bcf1ddfa862f8029ba))
* cached os.pathconf() call in _record_path() ([#1920](https://github.com/maarten-k/snakemake/issues/1920)) ([551badb](https://github.com/maarten-k/snakemake/commit/551badb4eb9de582278185449d8fa9298ad7ae8c))
* Gfal2 remote provider using gfal2-python instead of  gfal2-utils. ([#2128](https://github.com/maarten-k/snakemake/issues/2128)) ([0b9bfe5](https://github.com/maarten-k/snakemake/commit/0b9bfe500a06e669d2557d897ed26550aec526d6))
* Improve execution speed of cleanup_workdir (in dag)  ([#2103](https://github.com/maarten-k/snakemake/issues/2103)) ([1fbc5f5](https://github.com/maarten-k/snakemake/commit/1fbc5f5aee65bc8dd776765644d07051dd857670))


### Documentation

* add install info of development (git) version to docs ([#1477](https://github.com/maarten-k/snakemake/issues/1477)) ([2a2d6cd](https://github.com/maarten-k/snakemake/commit/2a2d6cd15cf48278ff17470c7c1323e7ebc40bbd))
* add sentence about workflow template to docs ([#1369](https://github.com/maarten-k/snakemake/issues/1369)) ([5fabffb](https://github.com/maarten-k/snakemake/commit/5fabffbb4af8e9e122677e5adeaebf2d6bd0eeb3))
* add workflows.community metadata ([#1736](https://github.com/maarten-k/snakemake/issues/1736)) ([8a42afc](https://github.com/maarten-k/snakemake/commit/8a42afc053e3f398f1a299fb3234ca0ee847faae))
* added changelog info for &gt;v7.19.1 parsing error of "hh:mm:ss" time format in runtime resource ([#2189](https://github.com/maarten-k/snakemake/issues/2189)) ([2889f38](https://github.com/maarten-k/snakemake/commit/2889f3851b64cee7885fbf73f64a453eed5e806a))
* Change snakemake-tutorial download link to always be the latest ([#2183](https://github.com/maarten-k/snakemake/issues/2183)) ([ae8a8f4](https://github.com/maarten-k/snakemake/commit/ae8a8f4abca233e0c162e3fbd9dfb29ef38f98e6))
* checkpoint documentation ([#1562](https://github.com/maarten-k/snakemake/issues/1562)) ([4cbfb47](https://github.com/maarten-k/snakemake/commit/4cbfb4786a729a0c899a0a3e0427c1c1f0796c15))
* clarify namespacing when using modules. ([dbed4a3](https://github.com/maarten-k/snakemake/commit/dbed4a3f160106feb15a51d2e8cfcafae531ea57))
* Clarify the use of conda with notebook directive ([#1515](https://github.com/maarten-k/snakemake/issues/1515)) ([aefb1eb](https://github.com/maarten-k/snakemake/commit/aefb1eb0a2d62faa6108670f3a11d58a1d797c41))
* Command line arguments for configuration files ([#1343](https://github.com/maarten-k/snakemake/issues/1343)) ([ad8aaa4](https://github.com/maarten-k/snakemake/commit/ad8aaa4853a150211513baecc474956575d326eb))
* details on benchmarked results ([64fea09](https://github.com/maarten-k/snakemake/commit/64fea0921f6a35dbea96435debb114012603ffc2))
* display rust-script env. ([950d8ba](https://github.com/maarten-k/snakemake/commit/950d8ba785a384fa47fcda3d6fb948799a259e0e))
* explain automatic decompression strategy for http remote provider ([e6826b6](https://github.com/maarten-k/snakemake/commit/e6826b6a740ba5b8877f12732c4ad95194833e07))
* explain relative path interpretation ([#1428](https://github.com/maarten-k/snakemake/issues/1428)) ([add9a05](https://github.com/maarten-k/snakemake/commit/add9a05eecf10f45113bc511a1d166e1708ff756))
* explain SNAKEMAKE_PROFILE environment variable ([2b32bba](https://github.com/maarten-k/snakemake/commit/2b32bba6efa53a9359bc67d8eb8ce06f1106e8ef))
* fix broken link in executor_tutorial/tutorial.rst ([#1360](https://github.com/maarten-k/snakemake/issues/1360)) ([c9be764](https://github.com/maarten-k/snakemake/commit/c9be76482d05577c4b1528b0e52ba15fc17a1dd5))
* fix formatting ([087fe63](https://github.com/maarten-k/snakemake/commit/087fe6307a72a577daefcea0cb150f69092138c7))
* fix grammar in the intro ([#1859](https://github.com/maarten-k/snakemake/issues/1859)) ([774bc6a](https://github.com/maarten-k/snakemake/commit/774bc6aaa3105c94a551691498d9a5efb13ac216))
* fix link ([4889c93](https://github.com/maarten-k/snakemake/commit/4889c93a031acc3ada22c9bdfd27301cce2c107e))
* fix list display in docs ([3724367](https://github.com/maarten-k/snakemake/commit/372436747a97496466b60dc60ee0ebe4cfef1016))
* fix list display in docs ([2dd0e91](https://github.com/maarten-k/snakemake/commit/2dd0e91f8b7e13d0ffcebe4ed11024a39357ebc7))
* fix long description type for pypi (set to markdown) ([d8d9b8f](https://github.com/maarten-k/snakemake/commit/d8d9b8f284d2863f672cd96fd96d2034806d52de))
* fix minor typos in a linting rule ([#2162](https://github.com/maarten-k/snakemake/issues/2162)) ([71e1171](https://github.com/maarten-k/snakemake/commit/71e1171a0dab824baed77bfe235268af9e095c1f))
* Fix problems with code blocks and broken internal link. ([#1424](https://github.com/maarten-k/snakemake/issues/1424)) ([5d4e7d8](https://github.com/maarten-k/snakemake/commit/5d4e7d8c4d7901c41bfb8f01c4b2c6551add59f7))
* fix small type in FAQ ([#1832](https://github.com/maarten-k/snakemake/issues/1832)) ([914172b](https://github.com/maarten-k/snakemake/commit/914172baf366570fa2a2818746d3ed1417790e3a))
* fix statement about logging ([#2252](https://github.com/maarten-k/snakemake/issues/2252)) ([56c24b6](https://github.com/maarten-k/snakemake/commit/56c24b6436cee9a4962d006bb201708c7a37c474))
* fix tutorial setup instructions for MacOS. ([#1383](https://github.com/maarten-k/snakemake/issues/1383)) ([b57b749](https://github.com/maarten-k/snakemake/commit/b57b7493d372605323204122af859ede38864e4d))
* fix typo ([e1c3cc6](https://github.com/maarten-k/snakemake/commit/e1c3cc6c6ddbf67e9d3cfc9dcef9bcf35b0060f3))
* fix typo ([#1843](https://github.com/maarten-k/snakemake/issues/1843)) ([6572ad9](https://github.com/maarten-k/snakemake/commit/6572ad91bed14dece6b01a26134007a25ef0c4b2))
* Fix typo and grammar mistake in scatter-gather section. ([#1441](https://github.com/maarten-k/snakemake/issues/1441)) ([f218aaa](https://github.com/maarten-k/snakemake/commit/f218aaad1b9b80074ea602cde0352c34c18e70b5))
* fix typo in installation.rst ([#1344](https://github.com/maarten-k/snakemake/issues/1344)) ([c45d47a](https://github.com/maarten-k/snakemake/commit/c45d47a79b78a1afed3b1319e6cafd1b2525fe43))
* Fix typo in rules.rst (—draft-notebook) ([#1290](https://github.com/maarten-k/snakemake/issues/1290)) ([f5c42cf](https://github.com/maarten-k/snakemake/commit/f5c42cfdc68f1516cec71b8ead8d78225ae915e5))
* Fix typo in SLURM help text ([#2049](https://github.com/maarten-k/snakemake/issues/2049)) ([79b7025](https://github.com/maarten-k/snakemake/commit/79b702528b9801d0283766f2da377d4b9daeebd2))
* fix typos ([e45b9e6](https://github.com/maarten-k/snakemake/commit/e45b9e608c31af5a5c3389520486d46935549eb4))
* fix typos ([151095d](https://github.com/maarten-k/snakemake/commit/151095ddc839860d33a27cafeb83260dc17d736b))
* fix typos in --help ([#2182](https://github.com/maarten-k/snakemake/issues/2182)) ([09f0cbe](https://github.com/maarten-k/snakemake/commit/09f0cbe9452a22bde768c7049eeb17f1c93db7ea))
* format table ([4180a1b](https://github.com/maarten-k/snakemake/commit/4180a1b6a8b7104e27a748c638275b98c5998200))
* Improve error message when rule contains multiple run/shell/script/notebook/wrapper/template_engine/cwl keywords ([#2186](https://github.com/maarten-k/snakemake/issues/2186)) ([cd5a3c4](https://github.com/maarten-k/snakemake/commit/cd5a3c44eace393f24d9338b21d5ef3cb6298126))
* link to list of dependencies from installation ([#1336](https://github.com/maarten-k/snakemake/issues/1336)) ([99d7bfe](https://github.com/maarten-k/snakemake/commit/99d7bfef1285f131d0e60331511bc4833e7e414a))
* mention XDG_CACHE_HOME ([#2057](https://github.com/maarten-k/snakemake/issues/2057)) ([ec2ef45](https://github.com/maarten-k/snakemake/commit/ec2ef45c5e49f97a0b58535f8e39152d2789d428))
* polished text and table display ([413356c](https://github.com/maarten-k/snakemake/commit/413356cceb8d3a96b24531ef350168e681c9d383))
* replace `nosetest` with `pytest` ([#2211](https://github.com/maarten-k/snakemake/issues/2211)) ([f6b3c47](https://github.com/maarten-k/snakemake/commit/f6b3c47983bfe436f8ec33ab5830ba577fc38f90))
* separate api docs ([ded7da9](https://github.com/maarten-k/snakemake/commit/ded7da90258284f06d4e9263e667cd632cdc12ae))
* separate api docs ([#1499](https://github.com/maarten-k/snakemake/issues/1499)) ([5cf275a](https://github.com/maarten-k/snakemake/commit/5cf275ab9c556dd1828a0618799bcdba0c561e70))
* singularity sometimes uses system /tmp explanation ([#1588](https://github.com/maarten-k/snakemake/issues/1588)) ([170c1d9](https://github.com/maarten-k/snakemake/commit/170c1d9d92de4cafc0da9567a6970b173161c7da))
* small tweaks to flux documentation ([#1886](https://github.com/maarten-k/snakemake/issues/1886)) ([f29b371](https://github.com/maarten-k/snakemake/commit/f29b37106727c470b691076189e92f35e4cecfb6))
* temaplte rendering examples and available variables ([#1431](https://github.com/maarten-k/snakemake/issues/1431)) ([5995e9e](https://github.com/maarten-k/snakemake/commit/5995e9ebf7b037479b3f1317cb920773410bd2f2))
* update contribution docs ([09a5595](https://github.com/maarten-k/snakemake/commit/09a559504d7a4346e40d8b3a99ece46e903ff7a0))
* update copyright year ([#1427](https://github.com/maarten-k/snakemake/issues/1427)) ([6b9f5da](https://github.com/maarten-k/snakemake/commit/6b9f5da0c986d5de444e00b45656dba85244a6c7))
* update docs for azbatch and dockerhub ref ([#2298](https://github.com/maarten-k/snakemake/issues/2298)) ([908dbf1](https://github.com/maarten-k/snakemake/commit/908dbf143d4b1625fa6ee80f2b4eb713a6411a3f))
* update misc/vim/Readme with info for packer.nvim ([#2095](https://github.com/maarten-k/snakemake/issues/2095)) ([32166a7](https://github.com/maarten-k/snakemake/commit/32166a7fce95312bfa6b6d3ae76bf94accf6d5de))
* Update modularization.rst ([#2137](https://github.com/maarten-k/snakemake/issues/2137)) ([16954c7](https://github.com/maarten-k/snakemake/commit/16954c7b633049df6646275139251097d574fd35))
* update URL to emacs snakemake-mode ([#1339](https://github.com/maarten-k/snakemake/issues/1339)) ([dae7b8f](https://github.com/maarten-k/snakemake/commit/dae7b8fb0e580a1878d36881cfb5ffc8adeaeb9f))
* Update workflow syntax with priority directive ([#2188](https://github.com/maarten-k/snakemake/issues/2188)) ([af10db5](https://github.com/maarten-k/snakemake/commit/af10db56b11badfab2aa4f3aa9fa4bbe3c05fe7d))
* various little fixes ([#1875](https://github.com/maarten-k/snakemake/issues/1875)) ([b93f8e3](https://github.com/maarten-k/snakemake/commit/b93f8e316cb2f51e72933e7a28872bdf523aec11))
* zenodo example ([76159ae](https://github.com/maarten-k/snakemake/commit/76159ae22539e38923712e487371a5f32d7cb3cf))
